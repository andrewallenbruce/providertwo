...
rlang::on_load({
  ...
  aka$caid <- list(
    current                   = list(
      ...
      serv_behavior           = "Behavioral Health Services Provided to the Medicaid and CHIP Population",
      ...
      wind_historic           = "Separate CHIP Enrollment by Month and State Historic CAA/Unwinding Period",
