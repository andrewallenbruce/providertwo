...
end_caid <- list(
  current = list(
    ...
    chip_app_state = "State Medicaid and CHIP Applications, Eligibility Determinations, and Enrollment Data",
    chip_pro_state = "State Medicaid and CHIP Eligibility Processing Data",
    ...
    man_state_end = "^Managed Care Programs\\sby\\sState$",
