...
end_care <- list(
  current = list(
    ...
    spice_acute   = "Medicare Post-Acute Care & Hospice - by Geography and Provider",
  ...
  temporal = list(
    ...
    mds_nh_per    = "^Nursing Home Affiliated Entity Performance Measures$",
    ...
    # tmp_ALIAS = "Accountable Care Organization Participants",
    # tmp_ALIAS = "Accountable Care Organization Skilled Nursing Facility Affiliates",
    # tmp_ALIAS = "Accountable Care Organizations",
    # tmp_ALIAS = "Advance Investment Payment Spend Plan",
    # tmp_ALIAS = "Agency for Healthcare Research and Quality (AHRQ) Patient Safety Indicator 11 (PSI-11) Measure Rates",
    # tmp_ALIAS = "County-level Aggregate Expenditure and Risk Score Data on Assignable Beneficiaries",
    # tmp_ALIAS = "Deficit Reduction Act Hospital-Acquired Condition Measures",
    # tmp_ALIAS = "End-Stage Renal Disease Facility Aggregation Group Performance",
    # tmp_ALIAS = "Federally Qualified Health Center All Owners",
    # tmp_ALIAS = "Federally Qualified Health Center Enrollments",
    # tmp_ALIAS = "Fiscal Intermediary Shared System Attending and Rendering",
    # tmp_ALIAS = "Home Health Agency All Owners",
    # tmp_ALIAS = "Home Health Agency Enrollments",
    # tmp_ALIAS = "Home Infusion Therapy Providers",
    # tmp_ALIAS = "Hospice All Owners",
    # tmp_ALIAS = "Hospice Enrollments",
    # tmp_ALIAS = "Hospital All Owners",
    # tmp_ALIAS = "Hospital Change of Ownership",
    # tmp_ALIAS = "Hospital Change of Ownership - Owner Information",
    # tmp_ALIAS = "Hospital Enrollments",
    # tmp_ALIAS = "Hospital Price Transparency Enforcement Activities and Outcomes",
    # tmp_ALIAS = "Hospital Service Area",
    # tmp_ALIAS = "Long-Term Care Facility Characteristics",
    # tmp_ALIAS = "Managing Clinician Aggregation Group Performance",
    # tmp_ALIAS = "Medicare COVID-19 Hospitalization Trends",
    # tmp_ALIAS = "Medicare Fee-For-Service Public Provider Enrollment",
    # tmp_ALIAS = "Medicare Fee-for-Service Comprehensive Error Rate Testing",
    # tmp_ALIAS = "Medicare Post-Acute Care Utilization - Home Health Agency",
    # tmp_ALIAS = "Medicare Post-Acute Care Utilization - Home Health Agency by Geography/Provider and Case-Mix Grouping",
    # tmp_ALIAS = "Medicare Post-Acute Care Utilization - Hospice",
    # tmp_ALIAS = "Medicare Post-Acute Care Utilization - Inpatient Rehabilitation Facility",
    # tmp_ALIAS = "Medicare Post-Acute Care Utilization - Inpatient Rehabilitation Facility by Geography/Provider and Case-Mix Grouping",
    # tmp_ALIAS = "Medicare Post-Acute Care Utilization - Long-Term Care Hospital",
    # tmp_ALIAS = "Medicare Post-Acute Care Utilization - Skilled Nursing Facility",
    # tmp_ALIAS = "Medicare Post-Acute Care Utilization - Skilled Nursing Facility by Geography/Provider and Case-Mix Grouping",
    # tmp_ALIAS = "Medicare Provider and Supplier Taxonomy Crosswalk",
    # tmp_ALIAS = "Number of Accountable Care Organization Assigned Beneficiaries by County",
    # tmp_ALIAS = "Nursing Home Chain Performance Measures",
    # tmp_ALIAS = "Opt Out Affidavits",
    # tmp_ALIAS = "Order and Referring",
    # tmp_ALIAS = "Pending Initial Logging and Tracking Non Physicians",
    # tmp_ALIAS = "Pending Initial Logging and Tracking Physicians",
    # tmp_ALIAS = "Pioneer ACO Model",
    # tmp_ALIAS = "Provider of Services File - Clinical Laboratories",
    # tmp_ALIAS = "Provider of Services File - Hospital & Non-Hospital Facilities",
    # tmp_ALIAS = "Provider of Services File - Internet Quality Improvement and Evaluation System - Home Health Agency, Ambulatory Surgical Center, and Hospice Providers",
    # tmp_ALIAS = "Public Reporting of Missing Digital Contact Information",
    # tmp_ALIAS = "REACH ACOs",
    # tmp_ALIAS = "Revalidation Clinic Group Practice Reassignment",
    # tmp_ALIAS = "Revalidation Due Date List",
    # tmp_ALIAS = "Revalidation Reassignment List",
    # tmp_ALIAS = "Rural Health Clinic All Owners",
    # tmp_ALIAS = "Rural Health Clinic Enrollments",
    # tmp_ALIAS = "Skilled Nursing Facility All Owners",
    # tmp_ALIAS = "Skilled Nursing Facility Change of Ownership",
    # tmp_ALIAS = "Skilled Nursing Facility Change of Ownership - Owner Information",
    # tmp_ALIAS = "Skilled Nursing Facility Enrollments",
    # tmp_ALIAS = "Value Modifier"
  )
)
...
end_caid <- list(
  current = list(
    ...
    chip_presumptive    = "Presumptive Eligibility for Medicaid and CHIP Coverage",
    ...
    serv_behavior       = "^Behavioral Health Services\\s?Provided to the Medicaid and CHIP Population$",
    serv_perinatal      = "^Perinatal Care Services Provided to Medicaid and CHIP Beneficiaries ages 15 to 44",
    serv_screening      = "^Health Screenings Provided to Medicaid and CHIP Beneficiaries Under Age 19",
    serv_contraceptive  = "^Contraceptive Care Services Provided to Medicaid and CHIP Beneficiaries ages 15 to 44",
    ...
    serv_bloodlead      = "^Blood Lead Screening Services Provided to Medicaid and CHIP Beneficiaries",
    ...
    bene_preg           = "Number of pregnant and postpartum Medicaid and CHIP beneficiaries, 2017-2021",
    ...
    drug_con_mfg        = "Drug Manufacturer Contacts",
    drug_con_state      = "Medicaid Drug Rebate Program State Contact Information",
    ...
    man_state           = "^Managed Care Programs\\sby\\sState$",
    ...
    wind_trans          = "HealthCare\\.gov Transitions Marketplace Medicaid Unwinding Report",
    wind_historic       = "Separate CHIP Enrollment by Month and State\\sHistoric CAA/Unwinding Period",
...
end_prov <- list(
  current = list(
    ...
    cahps_hhc_patient       = "^Home Health Care [-] Patient Survey \\(HHCAHPS\\) 202[0-9]{1}Q[1-4]{1} to 202[0-9]{1}Q[1-4]{1}$",
    cahps_hhc_measure       = "^Home Health Care [-] Patient Survey \\(HHCAHPS\\) Measure Dates 202[0-9]{1}Q[1-4]{1} to 202[0-9]{1}Q[1-4]{1}$",
    cahps_hhc_nation        = "^Home Health Care [-] Patient Survey \\(HHCAHPS\\) National Data 202[0-9]{1}Q[1-4]{1} to 202[0-9]{1}Q[1-4]{1}$",
    cahps_hhc_state         = "^Home Health Care [-] Patient Survey \\(HHCAHPS\\) State Data 202[0-9]{1}Q[1-4]{1} to 202[0-9]{1}Q[1-4]{1}$",
    ...
    dial_listing            = "^Dialysis Facility [-] Listing by Facility$",
    dial_nation             = "^Dialysis Facility [-] National Averages$",
    dial_state              = "^Dialysis Facility [-] State Averages$",
    esrd_depress            = "^ESRD QIP [-] Clinical Depression Screening and Follow-up",
    esrd_complete           = "^ESRD QIP [-] Complete QIP Data",
    esrd_adequacy           = "^ESRD QIP [-] Dialysis Adequacy",
    esrd_footnote           = "^ESRD QIP [-] Footnotes",
    esrd_hypercalc          = "^ESRD QIP [-] Hypercalcemia",
    esrd_recon              = "^ESRD QIP [-] Medication Reconciliation",
    esrd_infect             = "^ESRD QIP [-] NHSN Bloodstream Infection",
    esrd_event              = "^ESRD QIP [-] NHSN Dialysis Event Measure",
    esrd_wait               = "^ESRD QIP [-] Percentage of Prevalent Patients Waitlisted",
    esrd_hosp               = "^ESRD QIP [-] Standardized Hospitalization Ratio",
    esrd_readmit            = "^ESRD QIP [-] Standardized Readmission Ratio",
    esrd_transfus           = "^ESRD QIP [-] Standardized Transfusion Ratio",
    esrd_perform            = "^ESRD QIP [-] Total Performance Scores",
    esrd_ultra              = "^ESRD QIP [-] Ultrafiltration Rate",
    esrd_vasc               = "^ESRD QIP [-] Vascular Access Topic",
    esrd_covid              = "^ESRD QIP [-] Covid-19 healthcare personnel Data",
    ...
    he_hosp                 = "^Health Equity [-] Hospital",
    he_nation               = "^Health Equity [-] National",
    ...
    hosp_footnote           = "^Footnote Crosswalk",
    hosp_update             = "^Data Updates",
    hosp_dates              = "^Measure Dates",
    hosp_maternal           = "^Maternal Health [-] Hospital",
    hosp_outcome            = "^Patient[-]Reported Outcomes [-] Hospital",
    hosp_general            = "^Hospital General Information",
    hosp_interop            = "^Promoting Interoperability [-] Hospital",
    hosp_birth              = "^Birthing Friendly Hospitals with Geocoded Addresses",
    voc_nation              = "^Value of care [-] National",
    voc_hosp                = "^Payment and value of care [-] Hospital",
    pmt_state               = "^Payment [-] State",
    pmt_nation              = "^Payment [-] National",
    ...
    nh_measure              = "^MDS Quality Measures$",
...
end_hgov <- list(
  current = list(
    ...
    partner_lookup     = "^Issuer[_]Partner[_]Lookup$",
