...
end_care <- list(
  current = list(
    ...
    # end_dial_facility = "^Medicare Dialysis Facilities$",
    ...
    restruct_betos = "^Restructured BETOS Classification System$",
    miss_contact = "^Public Reporting of Missing Digital Contact Information$",
    taxonomy_xwalk = "^Medicare Provider and Supplier Taxonomy Crosswalk$",
    man_caid = "^Medicaid Managed Care",
    enroll_beneficiary = "^Medicare Monthly Enrollment$",
    # end_nh_mds_fac = "^Facility-Level Minimum Data Set Frequency$",
    # end_nh_mds = "^Minimum Data Set Frequency$",
    mkt_cbsa = "^Market Saturation [&] Utilization Core[-]Based Statistical Areas$",
    mkt_state = "^Market Saturation [&] Utilization State[-]County$",
    drug_discard = "^Medicare Part B Discarded Drug Units$",
    drug_spend_caid = "^Medicaid Spending by Drug",
    ...
    opioid_care = "^Medicare Part D Opioid Prescribing Rates [-] by Geography$",
    ...
    # end_hha_cost = "^Home Health Agency Cost Report$",
    ...
    hosp_chow_own = "^Hospital Change of Ownership - Owner Information$",
    hosp_enroll = "^Hospital Enrollments$",
    hosp_service = "^Hospital Service Area",
    # end_hosp_cost = "^Hospital Provider Cost Report",
    ...
    snf_chow_own = "^Skilled Nursing Facility Change of Ownership [-] Owner Information$",
    snf_enroll = "^Skilled Nursing Facility Enrollments$",
    # end_snf_cost = "^Skilled Nursing Facility Cost Report$",
    # CMS Program Statistics are not accessible through the API
  ...
  temporal = list(
    ...
    nh_perform = "^Nursing Home Affiliated Entity Performance Measures$",
...
end_caid <- list(
  current = list(
    ...
    benes_integ = "Beneficiaries who could benefit from integrated care, 2017-2021",
    ...
    benes_preg = "Number of pregnant and postpartum Medicaid and CHIP beneficiaries, 2017-2021",
    benes_deliv = "Rate of NAS per 1,000 births in newborns whose deliveries were covered by Medicaid or CHIP, 2017 - 2019",
...
end_prov <- list(
  current = list(
    ...
    cahps_hhc_nation = "^Home Health Care [-] Patient Survey \\(HHCAHPS\\) National Data 2023Q4 to 2024Q3$",
    ...
    hosp_pi = "^Promoting Interoperability [-] Hospital",
