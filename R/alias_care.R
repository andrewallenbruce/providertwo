...
select_care <- function(x, call = caller_env()) {
  ...
  x <- switch(
    ...
    PROC_summary = "Physician\\/Supplier Procedure Summary",
    BENE_enroll = "Medicare Monthly Enrollment",
    ...
    ptD_prescribe = "Medicare Part D Opioid Prescribing Rates - by Geography",
