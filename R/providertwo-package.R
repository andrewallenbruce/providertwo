...
#' @importFrom cheapr %!in_% as_df cheapr_if_else cheapr_rev new_df seq_ sset which_ lag_ row_na_counts unlisted_length
...
#' @importFrom stringi stri_detect_regex stri_replace_all_regex stri_extract_all_regex stri_trim stri_extract_first_regex
#' @import httr2
#' @import S7
#' @import rlang
#' @import RcppSimdJson
